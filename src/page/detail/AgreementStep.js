    ...
    return(
        <div>
            <section>
                ...
                <div className="flex">
                    <input type="checkbox" checked={allChk} onChange={handleAllChkChange}/>
                    <p>이용약관 동의(필수) 및 개인정보 수집 이용 동의(필수)에 모두 동의합니다.</p>
                </div>
            </section>
            <section>
                <h3><input type="checkbox" checked={chk1} onChange={()=>{ setChk1(!chk1)}}/>[필수] 서비스이용약관</h3>
                <div>
                    <h4>제 1장 총칙</h4>
                    <h5>제 1 조 목적</h5>
            ...
            <section>
                <h3><input type="checkbox" checked={chk2} onChange={()=>{setChk2(!chk2)}}/>[필수] 개인정보처리방침</h3>
                    <h4>제 1장 총칙</h4>
            ...
            <button  onClick={handleNextBtnChange}>다음</button>
        </div>
    )
}
